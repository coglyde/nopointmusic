...
export default function RadioPage() {
  return (
    <PageShell
      ...
      kicker="Broadcasts"
      title="Radio"
      lede="Between the big headliners are countless artists with a sound and a story worth hearing, but nowhere to tell it. The No Point Music Radio Show gives them that stage - recorded live, aired in full. Hit play and it runs right here."
    >
      <RadioShows />
    </PageShell>
  );
