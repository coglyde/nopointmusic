...
const STATEMENT =
  "no point music exists for those who still want to be present; spaces where the energy is real and the music does the talking. people show up to feel the moment, not post stories. every night we build comes down to one thing: human connection.";
...
export function ManifestoReveal() {
  ...
  return (
    <section className="flex items-center px-6 py-[16vh] sm:min-h-[85svh] sm:py-[18vh] sm:px-10">
